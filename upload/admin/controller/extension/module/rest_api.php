...
class ControllerExtensionModuleRestApi extends Controller {
	...
	public function index() {
		...
		$this->load->model('extension/rest_api');

		//$this->model_extension_rest_api->addLicense("qwerasdfzxcv1qaz2wsx4rfv");
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/rest_api', 'token=' . $this->session->data['token'], true);
	...
	public function install() {
		$this->load->model('extension/rest_api');
		$this->model_extension_rest_api->install();
	}

	public function uninstall() {
		$this->load->model('extension/rest_api');
		$this->load->model('extension/event');
		$this->model_extension_rest_api->uninstall();
	}
