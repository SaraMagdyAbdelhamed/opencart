...
class ControllerAffiliateForgotten extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('restapi/affiliate/forgotten', '', true)
		);
		...
		$data['action'] = $this->url->link('restapi/affiliate/forgotten', '', true);

		$data['back'] = $this->url->link('restapi/affiliate/login', '', true);
