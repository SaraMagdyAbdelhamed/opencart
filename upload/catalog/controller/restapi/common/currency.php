<?php
class ControllerRestapiCommonCurrency extends Controller {
	public function index() {
		$this->load->language('common/currency');

		$data['text_currency'] = $this->language->get('text_currency');

		$data['action'] = $this->url->link('restapi/common/currency/currency', '', $this->request->server['HTTPS']);
		...
		if (!isset($this->request->get['route'])) {
			$data['redirect'] = $this->url->link('restapi/common/home');
		} else {
