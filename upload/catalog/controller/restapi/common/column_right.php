<?php
class ControllerRestapiCommonColumnRight extends Controller {
	public function index() {
		...
		if ($route == 'restapi/account/account') {

			$layout_id = $this->model_design_layout->getLayout('account/account');
		}
