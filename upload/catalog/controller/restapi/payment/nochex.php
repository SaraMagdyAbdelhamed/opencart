...
class ControllerRestapiPaymentNochex extends Controller {
	public function index() {
		...
		$data['success_url'] = $this->url->link('restapi/checkout/success', '', true);
		$data['cancel_url'] = $this->url->link('restapi/checkout/payment', '', true);
		$data['declined_url'] = $this->url->link('restapi/payment/nochex/callback', 'method=decline', true);
		$data['callback_url'] = $this->url->link('restapi/payment/nochex/callback', 'order=' . $this->session->data['order_id'], true);
