<?php
class ControllerRestapiPaymentSkrill extends Controller {
	public function index() {
		...
		$data['return_url'] = $this->url->link('restapi/checkout/success');
		$data['cancel_url'] = $this->url->link('restapi/checkout/checkout', '', true);
		$data['status_url'] = $this->url->link('restapi/payment/skrill/callback');
