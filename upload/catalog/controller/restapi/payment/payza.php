<?php
class ControllerRestapiPaymentPayza extends Controller {
	public function index() {
		...
		$data['ap_returnurl'] = $this->url->link('restapi/checkout/success');
		$data['ap_cancelurl'] = $this->url->link('restapi/checkout/checkout', '', true);
