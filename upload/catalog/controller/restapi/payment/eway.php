<?php
class ControllerRestapiPaymentEway extends Controller {
	public function index() {
		...
		$request->RedirectUrl = $this->url->link('restapi/payment/eway/callback', '', true);
		...
		if (isset($lbl_error)) {
			...
			if ($this->config->get('eway_paymode') == 'iframe') {
				$data['callback'] = $this->url->link('restapi/payment/eway/callback', 'AccessCode=' . $result->AccessCode, true);
