<?php
class ControllerRestapiPaymentPPPayflowIframe extends Controller {
	...
	public function paymentReturn() {
		$data['url'] = $this->url->link('restapi/checkout/success');
	...
	public function paymentCancel() {
		$data['url'] = $this->url->link('restapi/checkout/checkout');
