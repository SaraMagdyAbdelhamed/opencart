<?php
class ControllerRestapiPaymentPPProIframe extends Controller {
	...
	private function constructButtonData($order_info) {
		...
		$s_data['L_BUTTONVAR20'] = 'notify_url=' . $this->url->link('restapi/payment/pp_pro_iframe/notify', '', true);
		$s_data['L_BUTTONVAR21'] = 'cancel_return=' . $this->url->link('restapi/checkout/checkout', '', true);
		...
		$s_data['L_BUTTONVAR56'] = 'return=' . $this->url->link('restapi/checkout/success', '', true);
