<?php
class ControllerRestapiPaymentPaypoint extends Controller {
	public function index() {
		...
		$data['callback'] = $this->url->link('restapi/payment/paypoint/callback', '', true);
	...
	public function callback() {
		...
		if ($order_info) {
			...
			$data['text_success_wait'] = sprintf($this->language->get('text_success_wait'), $this->url->link('restapi/checkout/success'));
			$data['text_failure'] = $this->language->get('text_failure');
			$data['text_failure_wait'] = sprintf($this->language->get('text_failure_wait'), $this->url->link('restapi/checkout/cart'));
