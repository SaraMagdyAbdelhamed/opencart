<?php
class ControllerRestapiPaymentBluePayRedirect extends Controller {
	...
	public function send() {
		...
		$post_data['APPROVED_URL'] = $this->url->link('restapi/payment/bluepay_redirect/callback', '', true);
		$post_data['DECLINED_URL'] = $this->url->link('restapi/payment/bluepay_redirect/callback', '', true);
		$post_data['MISSING_URL'] = $this->url->link('restapi/payment/bluepay_redirect/callback', '', true);
