<?php
class ControllerRestapiPaymentFirstdata extends Controller {
	public function index() {
		...
		$data['url_success'] = $this->url->link('restapi/checkout/success', '', true);
		$data['url_fail'] = $this->url->link('restapi/payment/firstdata/fail', '', true);
		$data['url_notify'] = $this->url->link('restapi/payment/firstdata/notify', '', true);
