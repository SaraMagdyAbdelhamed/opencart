<?php
class ControllerRestapiPaymentLiqPay extends Controller {
	public function index() {
		...
		$xml .= '	<result_url>' . $this->url->link('restapi/checkout/success', '', true) . '</result_url>';
		$xml .= '	<server_url>' . $this->url->link('restapi/payment/liqpay/callback', '', true) . '</server_url>';
