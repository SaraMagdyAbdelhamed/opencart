<?php
class ControllerRestapiInformationContact extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('restapi/information/contact/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('restapi/information/contact')
		);
		...
		$data['action'] = $this->url->link('restapi/information/contact', '', true);
