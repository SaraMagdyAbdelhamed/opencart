...
class ControllerRestapiAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('restapi/account/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('restapi/account/register', '', true)
		);

		$data['heading_title'] = $this->language->get('heading_title');

		$data['text_account_already'] = sprintf($this->language->get('text_account_already'), $this->url->link('restapi/account/login', '', true));
		...
		$data['action'] = $this->url->link('restapi/account/register', '', true);
		...
		if ($this->config->get('config_account_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), '#', $information_info['title'], $information_info['title']);
$data['agree_link'] = $this->url->link('restapi/information/information/agree', 'information_id=' . $this->config->get('config_account_id'), true);
