...
class ControllerRestapiAccountEdit extends Controller {
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('restapi/account/edit', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('restapi/account/edit', '', true)
		);
		...
		$data['action'] = $this->url->link('restapi/account/edit', '', true);
