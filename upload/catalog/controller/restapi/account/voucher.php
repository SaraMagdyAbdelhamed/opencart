<?php
class ControllerRestapiAccountVoucher extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('restapi/account/voucher/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('restapi/account/voucher', '', true)
		);
		...
		$data['action'] = $this->url->link('restapi/account/voucher', '', true);
	...
	public function success() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('restapi/account/voucher')
		);
